              ...
              <h2 className="text-2xl font-bold mb-6 text-gray-800">Dades de Lliurament</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                     ...
                     <div className="space-y-2">
                        <Label htmlFor="email" className="text-gray-700">Adreça electrònica</Label>
                        <Input id="email" type="email" placeholder="el.teu@correu.com" required className="bg-gray-50 border-gray-300 text-gray-900" />
                    </div>
