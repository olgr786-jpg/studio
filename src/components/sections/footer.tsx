      ...
      <div className="container mx-auto px-4 md:px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-gray-300 font-sans">Aigua pura amb essència d’illa.</p>
            <div>
              <h3 className="text-lg font-semibold text-white mb-3 font-headline">Dades de Contacte</h3>
              <address className="not-italic text-gray-300 space-y-2 font-sans">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-gray-300 font-sans">Tens alguna pregunta o vols fer una comanda especial?</p>
            <ContactForm />
          </div>
          ...
          <div className="lg:col-span-2 lg:col-start-11 space-y-4">
            ...
            <nav className="flex flex-col space-y-2 font-sans">
              <Link href="#inici" className="text-gray-300 hover:text-secondary transition-colors">Inici</Link>
              <Link href="#productes" className="text-gray-300 hover:text-secondary transition-colors">Productes</Link>
              <Link href="#qui-som" className="text-gray-300 hover:text-secondary transition-colors">Qui Som</Link>
              <Link href="#blog" className="text-gray-300 hover:text-secondary transition-colors">Blog</Link>
              <div className="pt-2 space-y-2">
                <Link href="/tracking" className="block text-gray-300 hover:text-secondary transition-colors">Seguiment</Link>
                <Link href="/login" className="block text-gray-300 hover:text-secondary transition-colors">Login</Link>
              </div>
              <Link href="#contacte" className="text-gray-300 hover:text-secondary transition-colors">Contacte</Link>
            </nav>
          </div>

        </div>
        <div className="mt-16 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 font-sans">
